            ...
            <form>
                <div className="avatarContainer">
                    ...
                    <label htmlFor="avatarCreationInput">
                        <div className="avatar" ><img src={avatar.URL == "" ? "src\\assets\\Icons\\user.png" : avatar.URL} alt="Avatar" /></div>Wgraj avatar
                    </label>
                </div>
                ...
                <div className="radioContainer">
                    <label htmlFor="radioMale" className='radioOption'>
                        ...
                        <div className={"maleContainer " + (radioChecked == 'M' ? 'active' : '')}><img src="src\assets\Icons\male.png" alt="Male" /></div>
                    </label>
                    <label htmlFor="radioFemale" className='radioOption'>
                        ...
                        <div className={"femaleContainer " + (radioChecked == 'F' ? 'active' : '')}><img src="src\assets\Icons\femenine.png" alt="Female" /></div>
                    </label>
                </div>
            </form>
        </div>
