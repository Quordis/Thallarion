        ...
        <div className='religion'>
            ...
            <form>
                <label htmlFor="choiceElementis" className={'religionLabel ' + (radioValue == "Elementis" ? 'active' : '')}>
                    ...
                    <img src="src\assets\Images\Creation\Elementis-removebg-preview.png" alt="Elementis" />
                ...
                <label htmlFor="choiceMortave" className={'religionLabel ' + (radioValue == "Mortave" ? 'active' : '')}>
                    ...
                    <img src="src\assets\Images\Creation\Mortave-removebg-preview.png" alt="Mortave" />
                    <div className="religionTitle">
                        <h2>Mortave</h2>
                        <h4>Prawiara</h4>
                    </div>
                ...
                <label htmlFor="choiceAitheris" className={'religionLabel ' + (radioValue == "Aitheris" ? 'active' : '')}>
                    ...
                    <img src="src\assets\Images\Creation\Aitheris-removebg-preview.png" alt="Aitheris" />
                    <div className="religionTitle">
                        <h2>Aitheris</h2>
                        <h4>Panteon</h4>
                    </div>
