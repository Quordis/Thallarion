            ...
            <div className="traitsContainer">
                <div className="traitOption" onClick={handleTrait}>
                    <div className="traitLogo">
                        <img src="static\Images\Icons\Traits\handshake.png" alt="Lojalny" />
                    </div>
                ...
                <div className="traitOption" onClick={handleTrait}>
                    <div className="traitLogo">
                        <img src="static\Images\Icons\Traits\lantern.png" alt="Pomysłowy" />
                    </div>
                    <div className="traitTexts">
                ...
                <div className="traitOption" onClick={handleTrait}>
                    <div className="traitLogo">
                        <img src="static\Images\Icons\Traits\tree.png" alt="Rodzinny" />
                    </div>
                    <div className="traitTexts">
                ...
                <div className="traitOption" onClick={handleTrait}>
                    <div className="traitLogo">
                        <img src="static\Images\Icons\Traits\hourglass.png" alt="Zdyscyplinowany" />
                    </div>
                    <div className="traitTexts">
                ...
                <div className="traitOption" onClick={handleTrait}>
                    <div className="traitLogo">
                        <img src="static\Images\Icons\Traits\fist.png" alt="Zdeterminowany" />
                    </div>
                    <div className="traitTexts">
                ...
                <div className="traitOption" onClick={handleTrait}>
                    <div className="traitLogo">
                        <img src="static\Images\Icons\Traits\lute.png" alt="Bard" />
                    </div>
                    <div className="traitTexts">
                ...
                <div className="traitOption" onClick={handleTrait}>
                    <div className="traitLogo">
                        <img src="static\Images\Icons\Traits\door.png" alt="Otwarty" />
                    </div>
                    <div className="traitTexts">
                ...
                <div className="traitOption" onClick={handleTrait}>
                    <div className="traitLogo">
                        <img src="static\Images\Icons\Traits\knight.png" alt="Rycerski" />
                    </div>
                    <div className="traitTexts">
                ...
                <div className="traitOption" onClick={handleTrait}>
                    <div className="traitLogo">
                        <img src="static\Images\Icons\Traits\money-bag.png" alt="Handlowiec" />
                    </div>
                    <div className="traitTexts">
                ...
                <div className="traitOption" onClick={handleTrait}>
                    <div className="traitLogo">
                        <img src="static\Images\Icons\Traits\search.png" alt="Dokładny" />
                    </div>
                    <div className="traitTexts">
                ...
                <div className="traitOption" onClick={handleTrait}>
                    <div className="traitLogo">
                        <img src="static\Images\Icons\Traits\bowl.png" alt="Asceta" />
                    </div>
                    <div className="traitTexts">
                ...
                <div className="traitOption" onClick={handleTrait}>
                    <div className="traitLogo">
                        <img src="static\Images\Icons\Traits\candle.png" alt="Teolog" />
                    </div>
                    <div className="traitTexts">
                ...
                <div className="traitOption" onClick={handleTrait}>
                    <div className="traitLogo">
                        <img src="static\Images\Icons\Traits\parchment.png" alt="Sumienny" />
                    </div>
                    <div className="traitTexts">
                ...
                <div className="traitOption" onClick={handleTrait}>
                    <div className="traitLogo">
                        <img src="static\Images\Icons\Traits\owl.png" alt="Mądry" />
                    </div>
                    <div className="traitTexts">
                ...
                <div className="traitOption" onClick={handleTrait}>
                    <div className="traitLogo">
                        <img src="static\Images\Icons\Traits\treasure-map.png" alt="Podróżnik" />
                    </div>
                    <div className="traitTexts">
                ...
                <div className="traitOption" onClick={handleTrait}>
                    <div className="traitLogo">
                        <img src="static\Images\Icons\Traits\tool-box.png" alt="Zaradny" />
                    </div>
                    <div className="traitTexts">
                ...
                <div className="traitOption" onClick={handleTrait}>
                    <div className="traitLogo">
                        <img src="static\Images\Icons\Traits\sword.png" alt="Waleczny" />
                    </div>
                    <div className="traitTexts">
                ...
                <div className="traitOption" onClick={handleTrait}>
                    <div className="traitLogo">
                        <img src="static\Images\Icons\Traits\lance.png" alt="Turniejowicz" />
                    </div>
                    <div className="traitTexts">
